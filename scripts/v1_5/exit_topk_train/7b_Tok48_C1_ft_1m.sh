...
srun torchrun \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/ckpts-topk/llava-v1.5-7b-exit-topk-Tok48-C1-pretrain/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir ./checkpoints/ckpts-topk/llava-v1.5-7b-exit-topk-Tok48-C1-nov-1m \
    --num_train_epochs 1 \
