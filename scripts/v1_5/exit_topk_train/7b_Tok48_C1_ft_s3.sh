...
srun torchrun \
    ...
    --model_name_or_path ./checkpoints/ckpts-topk/llava-v1.5-7b-exit-topk-Tok48-C1 \
    --version v1 \
    --data_path ../../datasets/Open-LLaVA-NeXT-dataset/open-llava-next/open-llava-next_instruct_increment_335k.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/ckpts-topk/llava-v1.5-7b-exit-topk-Tok48-C1-nov-increment \
    --num_train_epochs 1 \
    ...
    --late_entry_layer  9 \
    --early_exit_layer 25 \
    --layer_list "[10,13,16,19]" \
    --image_token_keep_list "[112,10,5,1]" \
    --report_to wandb
