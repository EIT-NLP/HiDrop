...
def parse_args():
    ...
    parser.add_argument('--dir', type=str, default="../../datasets/LLaVA-1.5-dataset/eval/vqav2")
...
if __name__ == '__main__':
    ...
    src = os.path.join(args.eval_dir, 'answers', args.split, args.ckpt, 'merge.jsonl')
    test_split = os.path.join(args.dir, 'llava_vqav2_mscoco_test2015.jsonl')
    dst = os.path.join(args.eval_dir, 'answers_upload', args.split, f'{args.ckpt}.json')
